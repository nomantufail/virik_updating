        ...
        <div class="panel-body">
            ...
            <div class="list-group">
                ...
                <div class="col-md-12" style="height: 70px; text-align: center; color: #2a6496;">
                    <h3>Calculation Sheet White Oil</h3>
                </div>

                <form class="form-horizontal" role="form" action="<?= base_url()."reports/calculation_sheet_white_oil/generate/" ?>" target="_blank" method="get">
